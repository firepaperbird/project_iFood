...
public class SqliteCookbookController extends SqliteDataController {
    ...
    private final int COLUMN_CREATEON_INDEX = 3;
    private final int COLUMN_DECRIPTION_INDEX = 4;
    private final int COLUMN_ISDELETE_INDEX = 5;
    ...
    public List<Model_Cookbook> getCookbookByUserId(String userId) {
        ...
        try {
            ...
            while (cs.moveToNext()) {
                ...
                cookbook.setCreateOn(Timestamp.valueOf(cs.getString(COLUMN_CREATEON_INDEX)));
                cookbook.setDescription(cs.getString(COLUMN_DECRIPTION_INDEX));
                cookbook.setDelete(cs.getString(COLUMN_ISDELETE_INDEX).equals("True"));
